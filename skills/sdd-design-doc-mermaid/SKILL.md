...
Common request patterns and guide selection. See the **When to Use What** section for complete mapping.
...
7. **Add reference:** `Diagram image path: ./diagrams/filename.png`
...
8. On success → Add `Diagram image path: ./diagrams/design_doc_01_sequence_api_sequence.png` to markdown
